    ...
    >
      <div className="relative rounded-2xl overflow-hidden h-full">
        ...
        <div className="relative">
          <div className="flex flex-col xl:flex-row xl:justify-between xl:items-center gap-3 p-4 ">
            <div className="flex items-center gap-3 min-w-0">
              <div className="h-10 w-10 rounded-2xl bg-bgColor/70 border border-boxBorderColor flex items-center justify-center overflow-hidden shadow-sm backdrop-blur">
                <img
      ...
      C281.638,399.11,270.06,411.018,256.498,411.018z"
                ...
                <div className="group rounded-2xl bg-bgColor/50 border border-boxBorderColor p-4 shadow-sm backdrop-blur hover:bg-bgColor/70 hover:shadow-md transition">
                  ...
                  <p className="text-base font-extrabold flex items-center gap-2">
                    ...
                    <a
                      ...
                      className={`${
                        Owner !== null ? "text-primary" : "text-textColor"
                      } hover:underline`}
                    >
              ...
              <div className="mt-4 group rounded-2xl bg-bgColor/50 border border-boxBorderColor p-4 shadow-sm backdrop-blur hover:bg-bgColor/70 hover:shadow-md transition">
                <p className="text-textTitleColor text-xs mb-2">
                  شناسایی شده توسط
                </p>
                <p className="text-base font-extrabold flex items-center gap-2 text-textColor">
                  <span className="h-9 w-9 rounded-2xl grid place-items-center bg-bgColor border border-boxBorderColor">
                    <svg
                      fill="currentColor"
                      width="18"
      ...
      C70.906,85.54,85.54,70.906,87.482,52.688H95c1.104,0,2-0.896,2-2v-4.376C97,45.207,96.104,44.312,95,44.312z"
              ...
              <div className="text-textColor mt-4 group rounded-2xl bg-bgColor/50 border border-boxBorderColor p-4 shadow-sm backdrop-blur hover:bg-bgColor/70 hover:shadow-md transition">
