...
const AdressActivity = ({ SetTokenSelected, TokenSelected, SetMiladi, Miladi, SetTokenTransfered, TokenTransfered, Transactions, SetTransactions }) => {
  ...
  return (
    ...
    >
      <div className="relative rounded-2xl overflow-hidden h-full">
        ...
        <div className="relative h-full flex flex-col">
          <div className="flex items-center justify-between gap-3 p-4 border-b border-b-boxBorderColor/70 shrink-0">
                        ...
                        <Dropdown.Trigger className="w-full">
                          ...
                          >
                            <span className="text-textColor inline-flex items-center gap-2">
                              <img src={`/images/${TokenSelected}.png`} className="w-5 h-5 object-contain" />
                              <span className="font-semibold">{TokenSelected}</span>
                            </span>
                          </Button>
                        </Dropdown.Trigger>
                          ...
                          {TokenTransfered.map((item, index) => (
                            <Dropdown.Option value={item.symbol} key={index}>
                              {({ selected, active }) => (
                                ...
                                >
                                  <MenuItem.Title>
                                    <img src={`/images/${item.symbol}.png`} className="w-5 h-5 inline-block ml-1" />
                                    {item.symbol}
                                  </MenuItem.Title>
                                </MenuItem>
                              )}
    ...
    />
                      ...
                      {Balance !== null ? (
                        <span>
                          ...
                          <small className="ml-1 opacity-80">{TokenSelected}</small>
                        </span>
                      ) : (
                        "نامشخص"
                      )}
    ...
    <path d="M17.0020048,13 C17.5542895,13 18.0020048,13.4477153 18.0020048,14 C18.0020048,14.5128358 17.6159646,14.9355072 17.1186259,14.9932723 L17.0020048,15 L5.41700475,15 L8.70911154,18.2928932 C9.0695955,18.6533772 9.09732503,19.2206082 8.79230014,19.6128994 L8.70911154,19.7071068 C8.34862757,20.0675907 7.78139652,20.0953203 7.38910531,19.7902954 L7.29489797,19.7071068 L2.29489797,14.7071068 C1.69232289,14.1045317 2.07433707,13.0928192 2.88837381,13.0059833 L3.00200475,13 L17.0020048,13 Z" />
                      ...
                      {typeof Transactions === "number" ? Transactions.toLocaleString() : "نامشخص"}
                    </p>
                  </div>
