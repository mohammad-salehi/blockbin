...
export async function GET(req,{params}) {
  ...
  } else if (address === 'T39kaCeRBBs5Z2v42N9KzvcGfdRhnaPook') {
    return NextResponse.json(responseData4)
  } else if (address === 'T87uzeRBBs5Z2v42N9KzvcGfdRhnaJuuL') {
    return NextResponse.json(responseData5)
  } else if (address === 'TiYgAVFFKIq5A2G83T7KavzLfdRhnaXppL') {
    return NextResponse.json(responseData6)
  } else if (address === 'TBSJ2TZGPi3KnAAACY6ch3Hh3jrUtopkYA') {
    return NextResponse.json(responseData7)
  } else if (address === 'TWZN2QXGLi3KnLTtMY2ch3Hh8jwUtoagro') {
