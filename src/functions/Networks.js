export const Networks = [
    { symbole2 : 'BTC', symbole: 'BTC', name: 'بیت‌کوین', color: '#f8a23a', id: 1, type: 'utxo' },
    { symbole2 : 'LTC', symbole: 'LTC', name: 'لایت‌کوین', color: '#345d9d', id: 3, type: 'utxo' },
    { symbole2 : 'BCH', symbole: 'BCH', name: 'بیت‌کوین‌کش', color: '#8dc351', id: 2, type: 'utxo' },
    { symbole2 : 'DOGE', symbole: 'DOGE', name: 'دوج‌کوین', color: '#dcc46c', id: 15, type: 'utxo' },
    { symbole2 : 'MATIC', symbole: 'MATIC', name: 'متیک', color: '#9f5cdc', id: 7, type: 'account' },
